...
const CreateItemContainer = () => {
  ...
  const captureFile: React.ChangeEventHandler<HTMLInputElement> = async (
    event: any
  ) => {
    ...
    <>
			<div className="createnftPage">
                ...
                <label className="fileBtn" htmlFor="u_file"> <img src={upload} alt=""/></label>
							<p className="acceptfile fileBtn">JPG, PNG, GIF, SVG. Max Size: 100mb</p>
							<div id="imgViewArea">
      ...
      <div className="auctionsuccessPop clsePop" style={{display:'none'}}>
        ...
        <div className="contArea">
          ...
          <div className="btnArea">
            <a href="#" onClick={() => {$(".auctionsuccessPop").hide(); setCapturedFileBuffer(null); history.push('/mycollection');}}>CONFIRM</a>
          </div>
        </div>
      </div>


      <div className="spinnerPop" style={{backgroundColor :'rgba(0, 0, 0, 0.10)',display:'none'}}  >
        <div className="contArea" style={{backgroundColor :'rgba(0, 0, 0, 0.0)'}}>
          <img src={Spinner}></img>
        </div>
      </div>
